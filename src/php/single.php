    ...
    <?php if ( have_posts() ) : ?>
      ...
      <nav class="mt4 tc">
        <?php
          ...
          ';
          if (!empty($next_post)) {
            echo '<a class="f5 mr2 ph3 pv2 dark-blue link dim fw5 dib br2 ba bw1" href="' . get_permalink($next_post->ID) .'" data-qa="articleLinkPrev">' . $next_post_text . '</a>';
          } else {
            echo '<a class="f5 mr2 ph3 pv2 silver hover-silver link fw5 dib br2 ba bw1" data-qa="articleLinkPrev">' . $next_post_text . '</a>';
          }
          ...
          $prev_post_text = '
            ...
            ';
          if (!empty($prev_post)) {
            echo '<a class="f5 ml2 ph3 pv2 dark-blue link dim fw5 dib br2 ba bw1" href="' . get_permalink($prev_post->ID) .'" data-qa="articleLinkNext">' . $prev_post_text . '</a>';
          } else {
            echo '<a class="f5 ml2 ph3 pv2 silver hover-silver link fw5 dib br2 ba bw1" data-qa="articleLinkNext">' . $prev_post_text . '</a>';
          }
        ?>
      </nav>
    <?php endif; ?>
